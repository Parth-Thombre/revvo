...
export const FeaturedCard = ({ item: {image, rating, name, address, price, map}, onPress }: Props) => {
  return (
...
export const Card = ({ item: {image, rating, name, address, price, map}, onPress }: Props ) => {
  return (
